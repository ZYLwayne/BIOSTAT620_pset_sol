...
quarto render your_quarto_document.qmd --to pdf --output-dir docs
...
```
coefs <- scan(file.path(getwd(), "data/coefs1.txt"), what = numeric())
quarto render code/quadratic.qmd --to html
